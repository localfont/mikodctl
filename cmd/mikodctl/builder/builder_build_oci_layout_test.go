...
CMD ["echo", "test-mikodctl-build-context-oci-layout-parent"]`, testutil.CommonImage)
...
CMD ["echo", "test-mikodctl-build-context-oci-layout"]`
			data.Temp().Save(dockerfile, "Dockerfile")
				...
				Output: func(stdout string, t tig.T) {
					assert.Assert(
						...
						strings.Contains(
							...
							"test-mikodctl-build-context-oci-layout",
						),
					)
				},
			}
