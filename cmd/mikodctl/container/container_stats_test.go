...
func TestStats(t *testing.T) {
	...
	if runtime.GOOS == "linux" {
		// this comment is for `mikodctl ps` but it also valid for `mikodctl stats` :
		// https://github.com/localfont/mikodctl/pull/223#issuecomment-851395178
	...
	testCase.SubTests = []*test.Case{
		...
		},
		{
			...
			// https://github.com/localfont/mikodctl/issues/1240
			// mikodctl used to print UINT64_MAX as the memory limit, so, ensure it does no more
