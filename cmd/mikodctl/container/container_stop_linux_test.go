...
import (
	...
	iptablesutil "github.com/localfont/mikodctl/v2/pkg/testutil/iptables"
...
func TestStopCleanupForwards(t *testing.T) {
	...
	// define iptables chain name depending on the target (docker/mikodctl)
	var chain string
...
// Regression test for https://github.com/localfont/mikodctl/issues/3353
