...
import (
	...
	testhelpers "github.com/localfont/mikodctl/v2/cmd/mikodctl/helpers"
...
func TestSave(t *testing.T) {
	...
	// See https://github.com/localfont/mikodctl/issues/3425 and others for details.
	testCase.Require = nerdtest.Private

	if runtime.GOOS == "windows" {
		testCase.Require = nerdtest.IsFlaky("https://github.com/localfont/mikodctl/issues/3524")
	}
	...
	testCase.SubTests = []*test.Case{
		{
			...
			Setup: func(data test.Data, helpers test.Helpers) {
				...
				var id string
				// Docker and Mikodctl do not agree on what is the definition of an image ID
...
// TestSaveMultipleImagesWithSameIDAndLoad tests https://github.com/localfont/mikodctl/issues/3806
