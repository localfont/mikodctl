...
// TestIssue3016 tests https://github.com/localfont/mikodctl/issues/3016
func TestIssue3016(t *testing.T) {
	...
	testCase.SubTests = []*test.Case{
		{
			Description: "Issue #3016 - Tags created using the short digest ids of container images cannot be deleted using the mikodctl rmi command.",
			Setup: func(data test.Data, helpers test.Helpers) {
