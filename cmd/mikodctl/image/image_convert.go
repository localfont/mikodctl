...
For encryption and decryption, use 'mikodctl image (encrypt|decrypt)' command.
`
...
func convertCommand() *cobra.Command {
	...
	cmd.Flags().String("nydus-work-dir", "", "Work directory path for image conversion, default is the mikodctl data root directory")
