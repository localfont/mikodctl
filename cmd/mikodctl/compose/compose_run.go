...
func runAction(cmd *cobra.Command, args []string) error {
	...
	// FIXME : https://github.com/localfont/mikodctl/blob/v0.22.2/cmd/mikodctl/run.go#L100
	tty := interactive
	...
	// https://github.com/localfont/mikodctl/blob/v0.22.2/cmd/mikodctl/run.go#L475
	if interactive && detach {
		return errors.New("currently flag -i and -d cannot be specified together (FIXME)")
	}

	// https://github.com/localfont/mikodctl/blob/v0.22.2/cmd/mikodctl/run.go#L479
	if tty && detach {
