...
func TestMatchesAnyLabel(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			imageLabels:   map[string]string{"org": "com.example.mikodctl"},
			labelsToMatch: map[string]string{"org": "com.example.mikodctl"},
			matches:       true,
		},
		{
		...
		},
		{
			...
			imageLabels:   map[string]string{"org": "com.example.mikodctl", "foo": "bar"},
